...
import com.canyapan.dietdiaryapp.preference.AppCompatPreferenceActivity;
import com.canyapan.dietdiaryapp.preference.TimePreference;
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                preference.setSummary(DateTimeHelper.convertLocalTimeToString(preference.getContext(),
                        timePreference.getHour(), timePreference.getMinute()));
                ...
                if (value instanceof String) {
                    ...
                    if (preference.getKey().equals(KEY_NOTIFICATIONS_ACTIVE)
                            || preference.getKey().equals(KEY_NOTIFICATIONS_DAILY_REMAINDER)) {
