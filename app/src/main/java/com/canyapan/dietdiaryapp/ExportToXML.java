...
class ExportToXML extends ExportAsyncTask {
    ...
    protected void start(final OutputStream outputStream, final LocalDate fromDate, final LocalDate toDate) throws IOException, ExportException {
        ...
        serializer.startTag(null, "events")
                .attribute(null, "startDate", fromDate.toString("dd/MM/yyyy"))
                .attribute(null, "endDate", toDate.toString("dd/MM/yyyy"));
    ...
    private void startDay(final LocalDate date) throws IOException {
        serializer.startTag(null, "day")
                .attribute(null, "date", date.toString("EEE, d MMM, yyyy"));
    }
