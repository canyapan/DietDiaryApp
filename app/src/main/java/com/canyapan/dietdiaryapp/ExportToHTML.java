...
class ExportToHTML extends ExportAsyncTask {
    ...
    protected void start(final OutputStream outputStream, final LocalDate fromDate, final LocalDate toDate) throws IOException, ExportException {
        ...
        serializer.docdecl("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Strict//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd\">");
...
*/
        ...
        serializer.startTag(NS_XHTML, "html")
                .startTag(NS_XHTML, "head")

                .startTag(NS_XHTML, "meta")
                .attribute(NS_XHTML, "http-equiv", "content-type")
                .attribute(NS_XHTML, "content", "text/html; charset=utf-8")
                .endTag(NS_XHTML, "meta")

                .startTag(NS_XHTML, "meta")
                .attribute(NS_XHTML, "name", "viewport")
                .attribute(NS_XHTML, "content", "width=device-width")
                .endTag(NS_XHTML, "meta")

                .startTag(NS_XHTML, "title")
                .text(
                ...
                .endTag(NS_XHTML, "title")

                //.startTag(NS_XHTML, "link")
                //.attribute(NS_XHTML, "rel", "stylesheet")
                //.attribute(NS_XHTML, "href", "css/foundation-emails.css")
                //.endTag(NS_XHTML, "link")
                .startTag(NS_XHTML, "style").text(getFoundationEmailsCSS()).endTag(NS_XHTML, "style")
                .startTag(NS_XHTML, "style")
                .text("body,html,.body{background:#f3f3f3!important}" +
                        ...
                        "table .desc{width:70%}")
                .endTag(NS_XHTML, "style")
                .endTag(NS_XHTML, "head")
...
*/
                .startTag(NS_XHTML, "body")
                .startTag(NS_XHTML, "table")
                .attribute(NS_XHTML, "class", "body")
                .attribute(NS_XHTML, "data-made-with-foundation", "")

                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "td")
                .attribute(NS_XHTML, "class", "float-center")
                .attribute(NS_XHTML, "align", "center")
                .attribute(NS_XHTML, "valign", "top")
                .startTag(NS_XHTML, "center").attribute(NS_XHTML, "data-parsed", "")

                .startTag(NS_XHTML, "table")
                .attribute(NS_XHTML, "class", "spacer float-center")
                .startTag(NS_XHTML, "tbody")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "td")
                .attribute(NS_XHTML, "height", "16px")
                .attribute(NS_XHTML, "style", "font-size:16px;line-height:16px;")
                .text("&#xA0;")
                .endTag(NS_XHTML, "td")
                .endTag(NS_XHTML, "tr")
...
*/
                .startTag(NS_XHTML, "table")
                .attribute(NS_XHTML, "align", "center")
                .attribute(NS_XHTML, "class", "container header float-center")
                .startTag(NS_XHTML, "tbody")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "td")
...
*/
                .startTag(NS_XHTML, "table")
                .attribute(NS_XHTML, "align", "center")
                .attribute(NS_XHTML, "class", "container body-border float-center")
                .startTag(NS_XHTML, "tbody")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "td")
                .startTag(NS_XHTML, "table").attribute(NS_XHTML, "class", "spacer")
                .startTag(NS_XHTML, "tbody")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "td")
                .attribute(NS_XHTML, "height", "16px")
...
*/
            serializer.endTag(NS_XHTML, "table")
                    .endTag(NS_XHTML, "th")
                    .endTag(NS_XHTML, "tr")
                    .endTag(NS_XHTML, "table")
                    .endTag(NS_XHTML, "th")
    ...
    private void beginDay(final LocalDate date) throws IOException {
        ...
        serializer.startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "th").attribute(NS_XHTML, "class", "small-12 large-12 columns first last")
                .startTag(NS_XHTML, "table")
                .startTag(NS_XHTML, "tr")
...
*/
        serializer.endTag(NS_XHTML, "tbody")
                ...
                .startTag(NS_XHTML, "th").attribute(NS_XHTML, "classs", "small-12 large-8 columns first")
                .startTag(NS_XHTML, "table")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "th")
                .startTag(NS_XHTML, "p")
                .startTag(NS_XHTML, "small")
                .text("This data was exported from Diet Diary app for android.")
                .endTag(NS_XHTML, "small")
                .endTag(NS_XHTML, "p")
                .endTag(NS_XHTML, "th")
                .endTag(NS_XHTML, "tr")
                .endTag(NS_XHTML, "table")
                ...
                .startTag(NS_XHTML, "th").attribute(NS_XHTML, "classs", "small-12 large-4 columns last")
                .startTag(NS_XHTML, "table")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "th")
...
*/
                ...
                .startTag(NS_XHTML, "tbody")
                .startTag(NS_XHTML, "tr")
                .startTag(NS_XHTML, "td").attribute(NS_XHTML, "height", "16px")
                .attribute(NS_XHTML, "style", "font-size:16px;line-height:16px;")
                .text("&#xA0;")
                .endTag(NS_XHTML, "td")
                .endTag(NS_XHTML, "tr")
                ...
                .endTag(NS_XHTML, "center")
                .endTag(NS_XHTML, "td")
                .endTag(NS_XHTML, "tr")
                .endTag(NS_XHTML, "table")

                .endTag(NS_XHTML, "body")
